    ...
    <b-navbar v-if="user" type="light" variant="light">
        <div class="container">
            <b-navbar-nav class="ml-2">
                <b-nav-item>
                    <b-link :to="{ name: 'posts' }"> Posts </b-link>
                </b-nav-item>
                <b-nav-item v-if="$gate.allow('viewAny', 'user')">
                    <b-link :to="{ name: 'users' }"> Users </b-link>
                </b-nav-item>
                <b-nav-item>
                    <b-link :to="{ name: 'edit_user' }"> Edit Profile </b-link>
                </b-nav-item>
            </b-navbar-nav>
            <b-navbar-nav>
...
export default {
    created() {
        console.log($gate.allow('viewAny', 'user'));
        // this.logout();
    },
    data: () => ({
